...
from sigma.pipelines.arroyosql import # TODO: add pipeline imports or delete this line
import sigma
import re
from typing import ClassVar, Dict, Tuple, Pattern, List, Any, Optional

class ArroyoSQLBackend(TextQueryBackend):
    """arroyo-sql backend."""
    ...
    name : ClassVar[str] = "arroyo-sql backend"
